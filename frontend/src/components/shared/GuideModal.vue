...
const steps = [
  ...
  },
  {
    ...
    color: '#FFD4A8',
    items: [
      '去 DeepSeek 官网（deepseek.com）注册一个账号，用手机号就行，完全免费',
      '登录后在左侧菜单找到「API Keys」，点击「创建 API Key」，复制那一长串英文数字（以 sk- 开头）',
      '回到本页面，进入充值中心（platform.deepseek.com），充 10 块钱就够了，够聊几个月',
      '10 块钱也就一杯奶茶的钱，够你和她聊到天荒地老',
    ],
  },
  {
    icon: Settings,
